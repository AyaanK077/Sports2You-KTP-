...
const styles = StyleSheet.create({
  ...
  statLabel: { fontSize: FONT_SIZE.xs, color: COLORS.text2, marginTop: 4, lineHeight: 17 },

  section: { padding: 28, paddingTop: 32, borderTopWidth: 1, borderTopColor: COLORS.border },
  sectionLabel: {
    fontSize: FONT_SIZE.xs,
    fontWeight: '800',
    color: COLORS.green,
  ...
  featureTitle: { fontSize: FONT_SIZE.lg, fontWeight: '700', color: COLORS.text, marginBottom: 8, letterSpacing: -0.2 },
  featureDesc: { fontSize: FONT_SIZE.sm, color: COLORS.text2, lineHeight: 22 },
  ...
  venueName: { fontSize: FONT_SIZE.xl, fontWeight: '700', color: COLORS.text, marginBottom: 8, letterSpacing: -0.2 },
  venueDesc: { fontSize: FONT_SIZE.sm, color: COLORS.text2, marginBottom: 14, lineHeight: 22 },
  courtBadges: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  courtBadge: {
    backgroundColor: 'rgba(57,217,138,0.08)',
    borderWidth: 1,
    borderColor: COLORS.border,
