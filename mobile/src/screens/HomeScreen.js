...
const styles = StyleSheet.create({
  ...
  subGreeting: { fontSize: FONT_SIZE.md, color: COLORS.text2, marginTop: 2 },
  avatar: {
    width: 44,
    height: 44,
    borderRadius: 22,
  ...
  ctaLabel: { fontSize: FONT_SIZE.xs, fontWeight: '800', color: 'rgba(255,255,255,0.7)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
  ctaTitle: { fontSize: FONT_SIZE.xl, fontWeight: '900', color: '#fff', marginBottom: 4 },
  ctaSub: { fontSize: FONT_SIZE.sm, color: 'rgba(255,255,255,0.75)' },
  ...
  statLabel: { fontSize: FONT_SIZE.xs, color: COLORS.text3, marginTop: 2, textAlign: 'center' },
  ...
  emptyText: { fontSize: FONT_SIZE.md, color: COLORS.text2, marginBottom: 16 },
  btnPrimary: {
    backgroundColor: COLORS.orange,
